...
## real example is smooth.spline() source code [still (2014-12-02) wrong!]
...
### --- 27 ----
## functions in named list: bodies should be indented "aligned"; 2nd is indented more
## From package robustbase {during development}:
.a.lst <-
    list(ex1 = function(p) {
        cMah <- qchisq(0.975, p)
