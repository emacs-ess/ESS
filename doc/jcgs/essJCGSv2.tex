...
%%S\date{\today}
\date{$ $Date: 2002/02/07 00:11:09 $ - $Revision: 1.139 $ $\tiny printed \today}
...
Emacs provides capabilities such as \stexttt{dired} mode,
...
buffer!  Tools such as \stexttt{etags} combined with
\stexttt{speedbar} provide a hyperlinked index to text objects, such
as S function definitions and \SAS\ proc/run combinations, across
files within a directory.  Other extensions to Emacs allow it to act
as a web browser, a mail and news reader, and providing spell checking
capabilities.
