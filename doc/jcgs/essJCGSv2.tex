...
%%S\date{\today}
\date{$ $Date: 2002/01/04 15:29:35 $ - $Revision: 1.37 $ $\tiny printed \today}
...
``interactive'' instead.  Ok?
 ...
 Martin: Don't think so; \emph{inferior} is well explained below,
 and we use it every in the ESS code itself. I think it would be
 unfortunate for documentation to use a different term than what the source
 code uses.
\end{Comment}
