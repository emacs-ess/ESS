...
%%S\date{\today}
\date{$ $Date: 2002/01/02 16:17:13 $ - $Revision: 1.31 $ $\tiny printed \today}
...
written in Emacs Lisp, (shortened as elisp), a dialect of Lisp
...
Rodney:  Remote batch file processing usually does not work.
My original comment stands:
I've not been able to get batch SAS file processing to work with
