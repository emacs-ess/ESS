...
provide GUI support.  Emacs menus and toolbars allow easy access to frequently used actions
for instances when you don't know or can't remember the keyboard
equivalent.  User-defined additional menus and
...
knows about programming languages with the help of Emacs packages, called modes.
Modes can provide
automatic indentation of programs and highlight, with fonts or colors,
specified syntactic characteristics.  A mode, and much of Emacs, is written in a
dialect of Lisp, called e-lisp \citep{RChassell1999,PGraham:1996}.  This means that
