...
%%S\date{\today}
\date{$ $Date: 2002/02/21 23:29:03 $ - $Revision: 1.242 $ $\tiny printed \today}
...
ESS is an interface to statistical packages which provides tools which
...
large number of platforms which include most Unix\regstrd
