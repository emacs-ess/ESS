...
%%S\date{\today}
\date{$ $Date: 2002/01/03 23:19:35 $ - $Revision: 1.34 $ $\tiny printed \today}
...
of the log.  \SAS\ batch file processing can work with \SAS\ running on 
the same machine as ESS or on a remote machine which is accessed over a 
...
Rodney:  I just checked in some changes that could make
ESS-elsewhere work with ESS[SAS] batch.  So, I guess we can
announce it, but I'd still like to hear from people who have
tried it since it is probably a bit buggy at the moment.
\end{quote}
