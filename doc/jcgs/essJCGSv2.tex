...
%%S\date{\today}
\date{$ $Date: 2002/01/10 15:24:03 $ - $Revision: 1.43 $ $\tiny printed \today}
...
standards.  Figure \ref{f.hilock} shows how to enfor a standard
for \SAS\ programming that says all \stexttt{PROC} statements must
have a \stexttt{DATA=datasetname} statement attached.
