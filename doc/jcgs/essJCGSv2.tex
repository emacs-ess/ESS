...
%%S\date{\today}
\date{$ $Date: 2002/02/07 19:21:00 $ - $Revision: 1.158 $ $\tiny printed \today}
...
Emacs buffers are the interface between the text editor and both the
user as well as the rest of the computer.  They can be considered to
be a collection of scratch pads that both the computer and the user
...
the user or automatically by Emacs.  Emacs will save a backup of the
...
activities.  One common program that is run within Emacs buffers is
