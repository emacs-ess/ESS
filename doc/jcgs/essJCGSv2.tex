...
%%S\date{\today}
\date{$ $Date: 2002/02/06 23:33:46 $ - $Revision: 1.131 $ $\tiny printed \today}
...
can be constructed to provide needed functionality; they can also
display a corresponding key binding if one exists.
