...
%%S\date{\today}
\date{$ $Date: 2002/02/04 19:38:58 $ - $Revision: 1.95 $ $\tiny printed \today}
...
behavior.  ESS solves this problem by providing a uniform keyboard
interface despite the variety of statistical packages that might be
used.  That is, the same keystrokes are used for cursor movement,
