...
%%S\date{\today}
\date{$ $Date: 2002/02/07 18:40:34 $ - $Revision: 1.153 $ $\tiny printed \today}
...
last decade, Emacs has been extended to use graphics-based windowing
systems such as X11\tm, Microsoft Windows, and Apple Mac OS.  These
...
actions, but binding commands to keystrokes still provides an
...
recall a key binding.  User-defined menus and toolbars can be
constructed as needed and as a pedagogical feature, can display the
corresponding key binding if one exists.
