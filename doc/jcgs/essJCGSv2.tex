...
%%S\date{\today}
\date{$ $Date: 2002/01/20 06:37:34 $ - $Revision: 1.77 $ $\tiny printed \today}
...
%% from within a buffer called \file{*S+elsewhere*},
...
%%The relevant commands get sent through the buffer \file{*S+elsewhere*} to
%%be executed by the program on the other machine.
The interaction,
...
\SAS\ program must exist on the computer where the \SAS\ program
...
Access to SAS on remote computers is nearly transparent to the user.
