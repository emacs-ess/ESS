...
%%S\date{\today}
\date{$ $Date: 2002/02/05 04:12:01 $ - $Revision: 1.101 $ $\tiny printed \today}
...
\noindent Keywords: Data Analysis, Programming, ESS, Emacs,
S, \SAS, \Splus, R, \XLispStat, \Stata, BUGS, free-software,
open-source, multi-platform, cross-platform
