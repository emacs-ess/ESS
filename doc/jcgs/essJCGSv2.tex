...
%%S\date{\today}
\date{$ $Date: 2002/02/05 16:42:38 $ - $Revision: 1.103 $ $\tiny printed \today}
...
\begin{abstract}
  ...
  for a variety of statistical analysis packages for most
  computer operating systems.  ESS is based on the Emacs
...
but command keymapping is still an
