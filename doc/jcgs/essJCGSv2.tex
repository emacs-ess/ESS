...
%%S\date{\today}
\date{$ $Date: 2002/02/19 15:02:38 $ - $Revision: 1.189 $ $\tiny printed \today}
...
In 1995, Rossini extended SAS-mode to work with XEmacs and merged S-mode 
and SAS-mode into a single Emacs package for statistical programming.  
