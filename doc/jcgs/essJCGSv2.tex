...
%% Rodney:  This is a historical comment and as such should be taken up in
%% that section.
...
%% Rodney:  Although, I believe the next sentence is true, I don't think it
%% is appropriate since we cannot expect to be unbiased about such
%% an assessment.
%%  This
%% gives ESS the ability to edit the programming language code, often
%% more smoothly than with editors distributed with the languages. 
...
%% Rodney:  The previous remarks apply all the time, but the following
%% remarks only apply to an interactive environment.  We should
%% either split into two paragraphs or make this distinction clear.
ESS knows the
