...
%%S\date{\today}
\date{$ $Date: 2002/02/05 22:58:12 $ - $Revision: 1.111 $ $\tiny printed \today}
...
\stexttt{vi}.  Modes can be programmed to control programs that
transfer files over a network, perform version control operations or
many other tasks.  
