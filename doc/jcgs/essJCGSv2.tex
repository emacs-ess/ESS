...
%%S\date{\today}
\date{$ $Date: 2002/01/09 22:37:43 $ - $Revision: 1.42 $ $\tiny printed \today}
...
%\stexttt{telnet} mode is 
%used for logging in to a remote machine, either securely by running \stexttt{ssh} or
%non-securely by running \stexttt{telnet}.
