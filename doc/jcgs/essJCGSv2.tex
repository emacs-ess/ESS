...
%%S\date{\today}
\date{$ $Date: 2002/02/20 19:41:36 $ - $Revision: 1.229 $ $\tiny printed \today}
...
between general packages and specialized packages.  
% For example, the command-line interfaces for \Stata and R are
% somewhat similar, but there are enough differences to create
% confusion.
ESS helps by providing a single point of contact to both tools, though
the typical interfaces (interactive for R, batch for BUGS) are
different.
