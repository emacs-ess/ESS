...
%%S\date{\today}
\date{$ $Date: 2002/02/19 18:27:05 $ - $Revision: 1.196 $ $\tiny printed \today}
...
can know the file type syntax and grammer and thus provide intelligent
...
unsecure (\stexttt{ange-ftp} and \stexttt{EFS} use ftp) and secure
