...
%There are 2 primary open-source versions of Emacs (Emacs and XEmacs),
...
have been stable for many, many years.  Currently, though, this is
mainly used for fast editing jobs or for special purposes like remote
access via a modem or the Internet.  In the last 10 years, Emacs has
been extended to use windowing systems such as X11, Microsoft Windows,
and the Apple Macintosh, and in most instances, this graphical user
interface (GUI) allows the user to interact with either a keyboard or
...
remember the keyboard equivalent.  User-defined menus and toolbars can
...
Emacs are called modes.  Major-modes provide 2 types of support.
First, it customizes the environment (keymaps, capabilities) for types
