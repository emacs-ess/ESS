...
%%S\date{\today}
\date{$ $Date: 2002/02/15 01:09:33 $ - $Revision: 1.175 $ $\tiny printed \today}
...
We start by describing the Emacs text editor; this is the underlying
platform for ESS.  Next, we discuss how ESS is involved in enhancing a
statistician's daily activities, by presenting its features,
operation, and how it facilitates statistical computing.  The unique
history of ESS as an open source project follows; it represents a
synthesis of several independent projects and has been passed down
through many generations of developers.  We conclude with future
