...
%%S\date{\today}
\date{$ $Date: 2002/02/05 03:23:02 $ - $Revision: 1.100 $ $\tiny printed \today}
...
like (see Modes).  I feel the same way about the two seperate discussions 
...
the string \stexttt{"deltat"} in rosy-purple.  The
