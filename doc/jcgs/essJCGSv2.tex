...
%%S\date{\today}
\date{$ $Date: 2002/02/06 00:51:18 $ - $Revision: 1.118 $ $\tiny printed \today}
...
Emacs extensions provide extensive
capabilities such as \stexttt{dired} mode, %(discussed in section \ref{sec:modes})
...
buffer!  Tools such \stextss{etags} combine with \stextss{speedbar} to
provide an hyperlinked index to features such as S function
