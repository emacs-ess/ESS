...
%%S\date{\today}
\date{$ $Date: 2002/02/05 22:27:09 $ - $Revision: 1.106 $ $\tiny printed \today}
...
computing activities.  The history of ESS follows; ESS is unique as an
...
but binding commands to keymaps provides an important time-saving
feature.  Emacs menus and toolbars on the display screen allow mouse
access to frequently used actions and provide a graphical alternative
when the user does not know or can not recall a keymap.  User-defined
