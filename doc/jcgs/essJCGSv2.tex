...
%%S\date{\today}
\date{$ $Date: 2002/01/31 22:54:19 $ - $Revision: 1.90 $ $\tiny printed \today}
...
%, which acts as a buffer between the statistician and computer, 
in the central role of facilitating statistical tasks.
%or hindering these tasks.  
This paper introduces Emacs Speaks Statistics (ESS)
\citep{ESS}, a software package designed to provide a 
% common, intelligent set of consistent shortcuts for frequent as well as complex tasks.
