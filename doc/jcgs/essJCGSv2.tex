...
%%S\date{\today}
\date{$ $Date: 2002/02/19 19:21:43 $ - $Revision: 1.201 $ $\tiny printed \today}
...
BUGS are also well supported for batch-style processing.  \Stata,
\XLispStat\ (including ARC and ViSta) are supported with the basic
functionality of syntax highlighting and process-interfacing.
