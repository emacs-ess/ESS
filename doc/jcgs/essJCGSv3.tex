...
\date{\today}
%%\date{$ $Date: 2002/09/24 05:15:08 $ - $Revision: 1.2 $ $\tiny printed \today}
...
exemplified in the notion that statistical activities can be
considered to be \textit{programming with data}, as per the book of
that name (cite: John Chambers).  The computer user interface is thus
placed in the central role of facilitating statistical tasks.  While
