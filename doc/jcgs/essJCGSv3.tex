...
\date{\today}
%%\date{$ $Date: 2002/10/02 06:55:21 $ - $Revision: 1.34 $ $\tiny printed \today}
...
We discuss how ESS enhances a statistician's daily activities
by presenting its features and showing how it facilitates statistical
computing.  We describe the Emacs text editor, the underlying
...
of files by function.   The more novel features, such as help
...
require some interaction with the target statistical package
either by controlling interactive behavior or by batch processing.
