...
\date{\today}
%%\date{$ $Date: 2002/10/01 13:53:06 $ - $Revision: 1.32 $ $\tiny printed \today}
...
\paragraph{Getting Help, Navigation and Editing.}
...
%% AJR: Is this really an issue, separate from the editing one? MM:agree
