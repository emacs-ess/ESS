...
\date{\today}
%%\date{$ $Date: 2002/09/24 05:22:59 $ - $Revision: 1.4 $ $\tiny printed \today}
...
be considered to be \textit{programming with data} \cite{ChaJ98}.  The
computer user interface is thus placed in the central role of
facilitating statistical tasks.  While presentation of character and
...
interprets user input.  A familiar, well-understood set of input
behaviors can increase the efficiency of statistical practice.  This
paper introduces Emacs Speaks Statistics (ESS) \citep{ESS}, a software
package which provides a common interface to a variety of statistical
packages on the most common computing platforms.
...
statistical languages.  It offers a single interface for a variety of
