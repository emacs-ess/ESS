...
\date{\today}
%%\date{$ $Date: 2002/10/03 16:56:36 $ - $Revision: 1.39 $ $\tiny printed \today}
...
\begin{figure}[tbp]%h
  \ESSfig{%
    %% new files made by
    %% convert -colorspace gray font-incor-s.gif font-incor-s-bw.eps
    %% convert -colorspace gray   font-cor-s.gif   font-cor-s-bw.eps
    \includegraphics[width=\textwidth]{font-cor-s-bw}
    \includegraphics[width=\textwidth]{font-incor-s-bw}
  }
