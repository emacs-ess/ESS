...
\date{\today}
%%\date{$ $Date: 2002/09/30 16:01:00 $ - $Revision: 1.25 $ $\tiny printed \today}
...
unbalanced parentheses and braces through highlighting, code
indentation for readability, commenting out regions, and indexing of
files by function.  However, the more novel features, such as help
