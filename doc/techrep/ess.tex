...
such as R and S-PLUS are limited in scope for Bayesian analyses, which
tools such as BUGS are useful for.  From another point of view,
specialized tools such as BUGS are not as easy to construct more
general analyses and graphics as S-PLUS and R.  This leads to an
efficiency gain when using multiple tools for both theoretical and
