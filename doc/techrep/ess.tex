...
including the Arc \textbf{CITE Cook and Weisberg} and ViSta
\citep{youn:fald:mcfa:1992} extensions; SAS \textbf{CITE SAS
  Institute}; Stata \textbf{CITE: Stata Corporation}; Omegahat
\citep{DTLang:2000}; and can be extended in at least a limited way to
most statistical packages which can be controlled from a command-line.
