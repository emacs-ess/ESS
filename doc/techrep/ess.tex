...
\author{A.J. Rossini \and Martin M{\"a}chler \and Kurt Hornik \and Richard
  M. Heiberger \and Rodney Sparapani \footnote{A.J. Rossini is
    Research Assistant Professor in the Department of Biostatistics,
    University of Washington and Joint Assistant Member at the Fred
    Hutchinson Cancer Research Center, Seattle, WA, USA (E-mail:
    rossini@u.washington.edu); Martin M{\"a}chler is ? in the Seminar for
    Statistics, ETH Zurich, Zurich, Switzerland (E-mail:
    maechler@stat.math.ethz.ch); Kurt Hornik is ? in the
    Wirtschaftsuniversit{\"a}t Wien and Technische Universit{\"a}t Wien,
    Vienna, Austria (E-mail: ?); Richard M. Heiberger is Professor 
    in the Department of Statistics at Temple
    University, Philadelphia, PA, USA (E-mail: rmh@temple.edu); and Rodney
    Sparapani is ? at the Medical College of Wisconsin, Milwaukee, WI,
    USA (E-mail: ?)}}
...
%% AJR: based on below, I commented this out, as well:
%% Emacs provides full customization of the keyboard and mouse.  
%% MM:  This appears already above (2nd to previous paragraph)!!
%%- The mouse-based interface, through menus and
...
% The code for the SAS macros or the analysis can be compared to similar code
...
% running SAS on a remote machine from a local Emacs,
