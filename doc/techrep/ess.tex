...
Emacs \citep{RMS:2000,RChassell1999} is a mature, powerful, and
extensible text editor which has been freely available for over 15
years and is available for a large number of platforms, including
those currently most frequently in use for statistical computing,
including Unix, Apple Corporation's Macintosh platform, and
Microsoft-based platforms.  While it does not fall into the category
of word processors, it does have similar features.
