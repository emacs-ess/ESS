...
\stexttt{ESS[S]} mode is automatically turned on when loading a file
with the file extensions \file{.R}, \file{.r}, \file{.S}, \file{.s},
\file{.ssc}, \file{.q}.  An inferior process must be running to take
advantage of the interactive features such as object- and file-name
completion and help.
...
S program %% we don't need to talk about R or S-PLUS when discussing
%% ``S'' in general.
...
The interactive \file{iESS [SAS:1]} buffer exists solely as a communications buffer.
