...
Emacs 
%% citep: "Writing GNU Emacs Extensions"
%        Bob Glickstein <bobg@zoger.ipost.com> O'Reilly & Assoc, ISBN 1-56592-261-1, about $30 list.
%"Sams Teach Yourself Emacs in 24 Hours (1999-04)"
%        http://www.mcp.com/info/0-672/0-672-31594-7/ ISBN 0-672-31594-7 $25
%        or http://www.mcp.com/ -> Product Support -> 0-672-31594-7
%        McMillan book publishing company.
%        By Jesper Pedersen, the author of "TDG -- The Dotfile generator!".
is a mature, powerful, and extensible text editor which has been
...
Another strength of Emacs is its extension language.  It was one of
the first tools with a programmable extension language, which is a
dialect of Lisp
%% \citep "ANSI Common Lisp" Paul Graham: ANSI
%% Common Lisp; Prentice Hall, 1996. 
, and has many examples of specialized extensions for tasks, including
strange ones such as spreadsheets, database front and backends, forms
entry, and even interactive games such as tetris.
