%%%- $Header: /scratch/CVS-ARCHIVE/ess-refcard/refcard.tex,v 1.15 2003/10/28 17:50:07 maechler Exp $
...
\begin{center}
  ...
  \\[1ex] {\tiny $ $Date: 2003/10/28 17:50:07 $ $}
...
\begin{tabTit}{Evaluation commands (Prefix \texttt{C-u}: \emph{visibly})}
