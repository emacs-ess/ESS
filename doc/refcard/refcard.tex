...
\begin{tabTit}{Evaluation commands (Prefix \texttt{C-u}: \emph{in/visibly})}
  ...
  \texttt{C-\RET, C-c C-n} & Evaluate region or line \&\emph{ step}  \\
...
\begin{tabI}
  ...
  \texttt{C-i, i} & Install package or library \\
  \texttt{C-l, l} & Load package or library \\
...
\begin{multicols}{2}
  ...
  \begin{tabI}
    ...
    \texttt{w}   & Display current page in \textbf{w}eb bro\textbf{w}ser\\
  \end{tabI}\\[0.5cm]
