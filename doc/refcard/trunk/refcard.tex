%%%- $Header: /scratch/CVS-ARCHIVE/ess-refcard/refcard.tex,v 1.12 2003/10/28 09:04:46 maechler Exp $
...
\begin{center}
  {\LARGE ESS {\normalsize \textbf{E}macs \textbf{S}peaks \textbf{Statistics}}
      \\[.5ex]   Reference Card}

  \smallskip

  {\small For version 5.x
    \\--- needs \em{more} updating!}
  %%MM \\ (SfS local version) %-SfS-added
  \\[1ex] {\footnotesize \$Date: 2003/10/28 09:04:46 $ $ --- as of \today}
\end{center}
...
\begin{tabTit}{Evaluation commands}
  ...
  {\tt C-c C-f} & \underline{Evaluate this function} \\
  {\tt C-c M-f} & Evaluate this function and go \\
  {\tt C-c C-r} & \underline{Evaluate this region} \\
...
\begin{tabTit}{SfS commands}                            %-SfS-added
  {\tt C-c f}   & insert function() header \\         %-SfS-added
