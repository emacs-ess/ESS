	     ...
	     (mapcar 'file-name-nondirectory
		     (apply 'nconc
			    (mapcar 'ess-find-exec-completions
				    ess-s-versions)))))
      (ess-write-to-dribble-buffer
       (format "(S): ess-s-versions-create making M-x defuns for %s"
...
")
	(while ess-s-versions-list
	  (setq this-S-version (car ess-s-versions-list)
		S-defun (car this-S-version)
		S-path (cadr this-S-version)
		S-args (caddr this-S-version)
		ess-s-versions-list (cdr ess-s-versions-list))
