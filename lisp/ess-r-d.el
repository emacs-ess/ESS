...
(defvar ess-dev-map
  (let (ess-dev-map)
    ...
    (define-key ess-dev-map "\C-l" 'ess-load-package)
    (define-key ess-dev-map "l" 'ess-load-package)
...
(defvar ess-r-package-dev-map
  (let (ess-r-package-dev-map)
    ...
    (define-key ess-r-package-dev-map "\C-c" 'ess-r-package-check-package)
    (define-key ess-r-package-dev-map "c"    'ess-r-package-check-package)
    (define-key ess-r-package-dev-map "\C-d" 'ess-r-package-document-package)
    (define-key ess-r-package-dev-map "d"    'ess-r-package-document-package)
    (define-key ess-r-package-dev-map "\C-i" 'ess-r-package-install-package)
    (define-key ess-r-package-dev-map "i"    'ess-r-package-install-package)
    (define-key ess-r-package-dev-map "\C-l" 'ess-r-package-load-package)
    (define-key ess-r-package-dev-map "l"    'ess-r-package-load-package)
    (define-key ess-r-package-dev-map "\C-r" 'ess-r-package-revdep-check-package)
    (define-key ess-r-package-dev-map "r"    'ess-r-package-revdep-check-package)
    (define-key ess-r-package-dev-map "\C-t" 'ess-r-package-test-package)
    (define-key ess-r-package-dev-map "t"    'ess-r-package-test-package)
    (define-key ess-r-package-dev-map "\C-u" 'ess-r-package-unload-package)
    (define-key ess-r-package-dev-map "u"    'ess-r-package-unload-package)
