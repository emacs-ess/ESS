...
(defvar ess-r-package-dev-map
  (let (ess-r-package-dev-map)
    ...
    (define-key ess-r-package-dev-map "\C-c" 'ess-r-check-package)
    (define-key ess-r-package-dev-map "c"    'ess-r-check-package)
    (define-key ess-r-package-dev-map "\C-d" 'ess-r-document-package)
    (define-key ess-r-package-dev-map "d"    'ess-r-document-package)
    (define-key ess-r-package-dev-map "\C-i" 'ess-r-install-package)
    (define-key ess-r-package-dev-map "i"    'ess-r-install-package)
    (define-key ess-r-package-dev-map "\C-l" 'ess-r-load-package)
    (define-key ess-r-package-dev-map "l"    'ess-r-load-package)
    (define-key ess-r-package-dev-map "\C-r" 'ess-r-revdep-check-package)
    (define-key ess-r-package-dev-map "r"    'ess-r-revdep-check-package)
    (define-key ess-r-package-dev-map "\C-t" 'ess-r-test-package)
    (define-key ess-r-package-dev-map "t"    'ess-r-test-package)
    (define-key ess-r-package-dev-map "\C-u" 'ess-r-unload-package)
    (define-key ess-r-package-dev-map "u"    'ess-r-unload-package)
