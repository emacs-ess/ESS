...
;; Created: 12 Nov 1993
;; Modified: $Date: 1999/04/01 00:10:46 $
;; Version: $Revision: 5.21 $
;; RCS: $Id: ess-site.el,v 5.21 1999/04/01 00:10:46 rossini Exp $
;;
...
(eval-and-compile
  ...
  ;; NON DEFAULTS:
  ;;(defvar ess-lisp-directory
  ;;(directory-file-name "/usr/local/lib/xemacs/site-lisp/ess-5.1.6/lisp"))
  ;;  >> or replace "ess-5.1.6" above by "ESS" which would be a symbolic link..
