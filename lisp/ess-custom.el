...
(defvar ess-indent-align-blocks '(if-else)
...
(defvar ess-style-alist
  `((BSD
     ...
     (ess-indent-align-blocks . (if-else))
    ...
    (DEFAULT
      ...
      (ess-indent-align-blocks . ,(default-value 'ess-indent-align-blocks))
...
Control variables:
 ...
 - `ess-indent-align-blocks': whether to ignore
