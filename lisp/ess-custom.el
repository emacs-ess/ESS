...
(defvar ess-style-alist
  `((BSD
     ...
     (ess-align-continuations-in-calls . ("[ \t]*(" "\\(if\\|all\\|any\\)[ \t]*(" "[^ \t]+\\["))
    ...
    (RRR-aligned
     ...
     (ess-align-nested-calls . ("ifelse"))
     (ess-align-arguments-in-calls . ("function[ \t]*("))
     (ess-align-continuations-in-calls . ,ess-align-continuations-in-calls)
     (ess-align-blocks . (control-flow))
     (ess-indent-from-lhs . t)
...
Provided default options are:
  ...
  `ess-gen-proc-buffer-name:projectile-or-simple' -- *proc:projectile-root* or *proc:dir*.
