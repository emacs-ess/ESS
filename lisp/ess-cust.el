...
;; Modified: $Date: 2004/06/30 16:46:29 $
;; Version: $Revision: 1.78 $
;; RCS: $Id: ess-cust.el,v 1.78 2004/06/30 16:46:29 stephen Exp $
...
(defcustom ess-versions-on-menu nil
"*If non-nil, place the functions generated by `ess-r-versions-create',
`ess-rterm-versions-create', and `ess-sqpe-versions-create' on the menu."
  :group 'ess
  :type  'boolean)
