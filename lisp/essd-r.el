...
;; RCS: $Id: essd-r.el,v 5.55 2004/07/02 07:45:48 rmh Exp $
;;
...
The result `ess-r-versions-created' will store a
list of the new R defuns, if any, that were created.  The result will
normally be bound to the added to global variable `ess-r-versions-created'.
