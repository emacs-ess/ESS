...
;; RCS: $Id: essd-r.el,v 5.52 2004/06/30 05:34:58 rmh Exp $
;;
  ...
  (if (not ess-R-root-dir)
      (setq ess-R-root-dir
	    (expand-file-name (concat
			       ...
			       "../../"))))
  (let* ((rwxxyy (file-name-all-completions "rw" ess-R-root-dir))
	 (Rterm (list (mapconcat
		       (lambda (rw) (concat ess-R-root-dir rw "bin/Rterm.exe"))
		       rwxxyy
		       " "))))
    Rterm))
