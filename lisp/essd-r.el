...
;;              Stephen Eglen < >
;; Created: 12 Jun 1997
;; Modified: $Date: 2004/07/02 10:19:44 $
;; Version: $Revision: 5.56 $
;; RCS: $Id: essd-r.el,v 5.56 2004/07/02 10:19:44 stephen Exp $
;;
...
Returns a list of strings of the names of the defuns that were created.
...
")
    (save-excursion
      ...
      (setq versions-2 versions)	;keep copy for returning at end.
