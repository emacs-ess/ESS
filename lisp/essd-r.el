...
;;              Stephen Eglen < >
;; Created: 12 Jun 1997
;; Modified: $Date: 2004/07/01 11:36:22 $
;; Version: $Revision: 5.54 $
;; RCS: $Id: essd-r.el,v 5.54 2004/07/01 11:36:22 stephen Exp $
;;
...
As a side-effect, the variable `ess-r-versions-created' will store a
list of the new R defuns, if any, that were created.  These will be
added to the menubar upon ESS initialisation."
