...
;;              Stephen Eglen < >
;; Created: 12 Jun 1997
;; Modified: $Date: 2004/06/23 12:30:20 $
;; Version: $Revision: 5.50 $
;; RCS: $Id: essd-r.el,v 5.50 2004/06/23 12:30:20 stephen Exp $
;;
...
")
    (save-excursion
      ...
      ;; Find which versions of R we want.
      (setq versions
	    (ess-uniq-list
	     (apply 'nconc 
		    (mapcar 'ess-find-exec-completions ess-r-versions))))
