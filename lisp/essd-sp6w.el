;;; essd-sp6w.el --- S-PLUS 6.x  for Windows customization
...
not point to S-Plus 6 or 7.  Please add `splus[67]?/cmd' (expand the
`[67]?' to match your setup) to your `exec-path' or specify the complete
